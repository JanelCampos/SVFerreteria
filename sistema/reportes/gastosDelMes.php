<?php
    ...
    $consulta = "
        SELECT *
        FROM gastos
        Where MONTH(fechaGasto) = MONTH(CURDATE())
...
<body>
	...
	<section id="container">
        ...
        <div class="header_container">
            <div class="row g-3 align-items-end">   
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <input class="filtrosBusqueda" type="text" name="descripcion" id="busquedaGastoMes" placeholder="Palabra clave">
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-primary" onclick="buscarGastoMes()">Aplicar filtros</button>
                        <a href="gastosDelMes.php" class="btn btn-outline-secondary">Restablecer</a>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-4 ms-lg-auto">
                    <div class="d-flex gap-2 justify-content-md-end">
                        <button class="btn btn-danger" type="button" onclick="exportarGastosMesPDF()">Exportar a PDF</button>
                        <button class="btn btn-success"  type="button" onclick="exportarGastosMesEXCEL()">Exportar a Excel</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php 
            renderPaginator($total_records, $results_per_page, $current_page, 'gastosDelMes.php');
        ?>
