<?php
    ...
    $consulta = "
        ...
        WHERE YEAR(v.Fecha) = '$anioActual'
        AND MONTH(v.Fecha) = '$mesActual'
...
<body>
	...
	<section id="container">
        <div class="bg-white p-3 rounded shadow mb-3">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="ventasDelDia.php" class="btn_new"><i class="fas fa-plus"></i> Ventas del día</a>
                </div>
            </div>
        </div>
        ...
        <div class="header_container">
            <div class="row g-3 align-items-end">   
                <div class="col-12 col-md-4 col-lg-3">
                    <label for="busquedaVentaMes">Id / Dni / Nombre Cliente</label>
                    <input class="filtrosBusqueda" type="text" name="busquedaVentaMes" id="busquedaVentaMes" placeholder="Id / Dni Cliente/ Nombre Cliente">
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <label for="busquedaNombreProductoMes">Nombre de Producto</label>
                    <input class="filtrosBusqueda" type="text" name="busquedaNombreProductoMes" id="busquedaNombreProductoMes" placeholder="Nombre de Producto">
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <label for="busquedaMedioPagoMes">Medio Pago</label>
                    <select class="filtrosBusqueda" name="busquedaMedioPagoMes" id="busquedaMedioPagoMes">
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <label for="busquedaEstadoMes">Estado</label>
                    <select class="filtrosBusqueda" name="busquedaEstadoMes" id="busquedaEstadoMes">
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-primary" onclick="buscarVentaMes()">Aplicar filtros</button>
                        <a href="ventasDelMes.php" class="btn btn-outline-secondary">Restablecer</a>    
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-4 ms-lg-auto">
                    <div class="d-flex gap-2 justify-content-md-end">
                        <button type="button" class="btn btn-danger" onclick="exportarVentasPDFMes()">Exportar PDF</button>
                        <button type="button" class="btn btn-success" onclick="exportarVentasEXCELMes()">Exportar Excel</button>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="btn-group dropend">
                                            ...
                                            <ul class="dropdown-menu">
                                                <?php 
                                                    ...
                                                    if($estadoVenta === 'pagado'){
                                                ?>
                                                    <li><button class="dropdown-item" type="button" onclick="mostrarFormulario('anularVentaMes',<?php echo $idVenta; ?>)">Anular</button></li>
                                                <?php 
                                                    }else if($estadoVenta === 'pendiente' || $estadoVenta === 'saldo'){
                                                ?>
                                                    <li><button class="dropdown-item" type="button" onclick="mostrarFormulario('pagarVentaMes', <?php echo $idVenta; ?>)">Pagar</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="mostrarFormulario('anularVentaMes', <?php echo $idVenta; ?>)">Anular</button></li>
                                                <?php 
                                                    }else{
                                                ?>
                                                    <li><button class="dropdown-item" type="button" onclick="mostrarFormulario('eliminarVentaMes',<?php echo $idVenta; ?>)">Eliminar</button></li>
                                                <?php 
                                                    }
                                                ?>
                                            </ul>
        ...
        <?php 
            renderPaginator($total_records, $results_per_page, $current_page, 'ventasDelMes.php');
        ?>
        <div id="paginator"></div>

        <div id="pagarVentaMes" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="tipoFiltro" name="tipoFiltro" value="mes">
                        <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-secondary" type="button" onclick="ocultarFormulario('pagarVentaMes')">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>

        <div id="anularVentaMes" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-secondary" type="button" onclick="ocultarFormulario('anularVentaMes')">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>

        <div id="eliminarVentaMes" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-secondary" type="button" onclick="ocultarFormulario('eliminarVentaMes')">Cerrar</button>
                    </div>
                </div>
            </div>
        </div>
