...
<body>
	...
	<section id="container">
        ...
        <div class="header_container">
            <div class="row g-3 align-items-end">   
                <div class="col-12 col-md-4 col-lg-3">
                    <label for="busquedaVenta">Id / Dni / Nombre Cliente</label>
                    <input class="filtrosBusqueda" type="text" name="busquedaVenta" id="busquedaVenta" placeholder="Id / Dni Cliente / Nombre Cliente">
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <label for="busquedaNombreProducto">Nombre de Producto</label>
                    <input class="filtrosBusqueda" type="text" name="busquedaNombreProducto" id="busquedaNombreProducto" placeholder="Nombre de Producto">
                </div>
                <div class="col-12 col-md-4 col-lg-3">
                    <label for="busquedaMedioPago">Medio Pago</label>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <label for="busquedaEstado">Estado</label>
                        <select class="filtrosBusqueda" name="busquedaEstado" id="busquedaEstado">
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-primary" onclick="buscarVenta()">Aplicar filtros</button>
                        <a href="ventas.php" class="btn btn-outline-secondary">Restablecer</a>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-4 ms-lg-auto">
                    <div class="d-flex gap-2 justify-content-md-end">
                        <button class="btn btn-danger" type="button" onclick="exportarVentasPDF()">Exportar a PDF</button>
                        <button class="btn btn-success"  type="button" onclick="exportarVentasEXCEL()">Exportar a Excel</button>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="btn-group dropend">
                                            ...
                                            <ul class="dropdown-menu">
                                                <?php 
                                                    ...
                                                    if($estadoVenta === 'pagado'){
                                                ?>
                                                    <li><button class="dropdown-item" type="button" onclick="mostrarFormulario('anularVenta',<?php echo $idVenta; ?>)">Anular</button></li>
                                                <?php 
                                                    }else if($estadoVenta === 'pendiente' || $estadoVenta === 'saldo'){
                                                ?>
                                                    <li><button class="dropdown-item" type="button" onclick="mostrarFormulario('pagarVenta', <?php echo $idVenta; ?>)">Pagar</button></li>
                                                    <li><button class="dropdown-item" type="button" onclick="mostrarFormulario('anularVenta', <?php echo $idVenta; ?>)">Anular</button></li>
                                                <?php 
                                                    }else{
                                                ?>
                                                    <li><button class="dropdown-item" type="button" onclick="mostrarFormulario('eliminarVenta',<?php echo $idVenta; ?>)">Eliminar</button></li>
                                                <?php 
                                                    }
                                                ?>
                                            </ul>
        ...
        <?php 
            renderPaginator($total_records, $results_per_page, $current_page, 'ventas.php');
        ?>
        <div id="paginator"></div>

        <div id="pagarVenta" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="tipoFiltro" name="tipoFiltro" value="total">
                        <div class="mb-3">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-secondary" type="button" onclick="ocultarFormulario('pagarVenta')">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>

        <div id="anularVenta" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-secondary" type="button" onclick="ocultarFormulario('anularVenta')">Cancelar</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="eliminarVenta" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-secondary" type="button" onclick="ocultarFormulario('eliminarVenta')">Cancelar</button>
                    </div>
                </div>
            </div>
        </div>
