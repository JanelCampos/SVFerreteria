...
function agregarFilaUnidad(data){
    ...
    html += '<option value="Und" '+(u.Unidad==='Und'?'selected':'')+'>Unidad (Und)</option>';
    html += '<option value="Kg" '+(u.Unidad==='Kg'?'selected':'')+'>Kilogramo (Kg)</option>';
    html += '<option value="g" '+(u.Unidad==='g'?'selected':'')+'>Gramo (g)</option>';
    html += '<option value="m" '+(u.Unidad==='m'?'selected':'')+'>Metro (m)</option>';
    html += '<option value="cm" '+(u.Unidad==='cm'?'selected':'')+'>Centímetro (cm)</option>';
    html += '<option value="L" '+(u.Unidad==='L'?'selected':'')+'>Litro (L)</option>';
    html += '<option value="ml" '+(u.Unidad==='ml'?'selected':'')+'>Mililitro (ml)</option>';
    html += '<option value="m²" '+(u.Unidad==='m²'?'selected':'')+'>Metro cuadrado (m²)</option>';
    html += '<option value="m³" '+(u.Unidad==='m³'?'selected':'')+'>Metro cúbico (m³)</option>';
    html += '<option value="Par" '+(u.Unidad==='Par'?'selected':'')+'>Par (Par)</option>';
    html += '<option value="Doc" '+(u.Unidad==='Doc'?'selected':'')+'>Docena (Doc)</option>';
    html += '<option value="Gal" '+(u.Unidad==='Gal'?'selected':'')+'>Galón (Gal)</option>';
    html += '<option value="Otro" '+(u.Unidad==='Otro'?'selected':'')+'>Otro</option>';
    html += '</select></div>';
