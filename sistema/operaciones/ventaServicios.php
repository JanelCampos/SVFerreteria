...
<body>
    ...
    <section id="container">
		...
		<?php
			...
			$listaClientes = "SELECT Nombre, Dni From clientes";
			...
			if (isset($_POST['confirmar'])) {
				...
				if (empty($_POST['dnideSocio'])) {	
					...
					$sql= "SELECT * FROM clientes WHERE Dni = '$dniSocio'";
				...
				if ($inputError != true) {
					...
					$consultaCodSocio="SELECT Id_Cliente FROM clientes
										WHERE Dni = '$dniSocio'";
					$codSocio=( ( $conexionDB->query($consultaCodSocio) )->fetch_object() )->Id_Cliente;
					...
					try {					    
						...
						if (!$queryVentas)
							...
							$instruccSQL="INSERT INTO detalle_venta_articulos (Cod_Venta, Cod_Clase, Periodo, Fecha_Alta, Fecha_Vencim, Total)
        ...
        <div class="datos_venta">
			...
			<form action="ventaServicios.php" method="post" class="datos">
				...
				<div class="wd40">
					...
					<input type="number" name="monto" placeholder="Ingrese monto" value="10" autofocus step="0.01"/>
				</div>
				<div class="wd30">
